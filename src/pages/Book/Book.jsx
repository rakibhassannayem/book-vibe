...
const Book = ({ singleBook }) => {
  ...
  return (
    <div className="card bg-base-100 shadow-sm border-1 border-base-300 rounded-2xl">
      ...
      <div className="card-body">
        <div className="card-actions">
          {tags.map((tag,index) => (
            <span key={index} className="badge badge-outline bg-green-50 border-0 rounded-full text-[#23be0a] font-medium text-[16px] text-workSans p-4">
              {tag}
            </span>
          ))}
        </div>
